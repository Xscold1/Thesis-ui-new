...
function EditDataset() {
  ...
  return (
    <div className="admin__dataset__content">
      <h1 className="header__title">Edit Dataset</h1>
      <h5 className="form__header">Dataset Details</h5>
        ...
        <div className="form__container">
          ...
          <form onSubmit={formik.handleSubmit}>
              ...
              {/* Sex Input */}
              <div>
                <label className="form__label" htmlFor="gender">Sex</label>
                <select
                  ...
                  value={formik.values.gender}>
                    ...
                    <option value="Male" selected={formik.values.gender==="Male"}>Male</option>
                    <option value="Female" selected={formik.values.gender==="Female"}>Female</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  value={formik.values.exercise}>
                    <option value="" hidden disabled="disabled" selected></option>
                    <option value="true" selected={formik.values.exercise===true}>True</option>
                    <option value="false" selected={formik.values.exercise===false}>False</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  value={formik.values.posture}>
                    <option value="" hidden disabled="disabled" selected></option>
                    <option value="true" selected={formik.values.posture===true}>True</option>
                    <option value="false" selected={formik.values.posture===false}>False</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  value={formik.values.smoker}>
                    <option value="" hidden disabled="disabled" selected></option>
                    <option value="true" selected={formik.values.smoker===true}>True</option>
                    <option value="false" selected={formik.values.smoker===false}>False</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  value={formik.values.unhealthyDiet}>
                    <option value="" hidden disabled="disabled" selected></option>
                    <option value="true" selected={formik.values.unhealthyDiet===true}>True</option>
                    <option value="false" selected={formik.values.unhealthyDiet===false}>False</option>
                </select>
              </div>
